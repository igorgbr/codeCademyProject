...
// rank and lastName, and returns a string in the following format: ‘rank 
...
console.log(reportingForDuty('Major', 'Lucca'));
console.log(reportingForDuty('Sargent', 'Pepper'));